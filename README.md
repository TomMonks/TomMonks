...
|---|---|
| [des_agent](https://github.com/pythonhealthdatascience/des_agent) | An AI agent system for autonomous discovery, configuration, experimentation, and reporting with discrete-event simulation (DES) models, demonstrating self-reflection and task planning agent architectures, and focusing on healthcare call centre optimization. |
...
| [sim-tools](https://github.com/TomMonks/sim-tools) | Tools to support Discrete-Event Simulation (DES) and Monte-Carlo Simulation education and practice. |
